...
3. After creating input prompt (including ICL examples), these txt files are stored in `Generated_files/final_k_each_similar_samples` folder and  `Generated_files/final_each_random_samples_k` folder where k = 1,2,4,8,16,32
